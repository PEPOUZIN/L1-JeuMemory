...
public class TransfertDlg extends javax.swing.JDialog {
    ...
    /**
     * Creates new form TransefertDlg
     */
    ...
    public void initPanneau() {
        ...
        lcs = lj.getJoueur(this.indjs).getPaquets();
        int t = lcs.getTaille();
        int n = 1 + (t - 1) / 4;
    ...
    public void affichePanneau() {
        for (int i = 0; i < lj.getJoueur(indjs).getPaquets().getTaille() - 1; i++) {
            JButton bt = (JButton) PanneauG.getComponent(i);
            bt.setIcon(new ImageIcon(lj.getJoueur(i).getPhoto()));

        }
    }

    private void boutonActionPerformed(ActionEvent evt) {
        LesPersonnages lp = lj.getJoueur(indjs).getPaquets();
        int t = lp.getTaille();
